...
if __name__ == '__main__':
    ...
    warmup_X = np.random.randint(0, 100, size=(5, 3))
    warmup_Y = np.random.randint(0, 100, size=(5, 3))
    ...
    # actual data setup
    elements = int(2e4)
    test_X = np.random.randint(0, 100, size=(elements, 3))
    test_Y = np.random.randint(0, 100, size=(elements, 3))
